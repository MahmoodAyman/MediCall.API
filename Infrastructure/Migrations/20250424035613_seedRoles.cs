...
namespace Infrastructure.Migrations
{
    ...
    public partial class seedRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { Guid.NewGuid().ToString(), Guid.NewGuid().ToString(), Role.User.ToString(), Role.User.ToString().ToUpper() },
        ...
        {
            migrationBuilder.Sql("DELETE FROM AspNetRoles WHERE Name IN ('Admin', 'User', 'Nurse', 'Patient')");
        }
    }
}
